...
public class SwaggerConfig {
    ...
    private ApiInfo apiEndPointsInfo() {
        return new ApiInfoBuilder().title("CALCULATOR API V1.0").description("CALCULATOR API")
                .contact(new Contact("Admin", "http://localhost", "info@calculator.com")).version("1.0.0").build();
    }
}
